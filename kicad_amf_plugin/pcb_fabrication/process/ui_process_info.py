...
class UiProcessInfo ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 492,370 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.label_pcb_thick = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"PCB Thickness"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.combo_board_thickness = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_board_thicknessChoices, 0 )
		self.combo_board_thickness.SetSelection( 0 )
		fgSizer26.Add( self.combo_board_thickness, 0, wx.ALL|wx.EXPAND, 5 )

		self.m_staticText41 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"mm"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText401 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"FInsihed Copper weight"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText401.Wrap( -1 )

		fgSizer25.Add( self.m_staticText401, 0, wx.ALL, 5 )

		combo_outer_copper_thicknessChoices = []
		self.combo_outer_copper_thickness = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_outer_copper_thicknessChoices, 0 )
		self.combo_outer_copper_thickness.SetSelection( 0 )
		fgSizer25.Add( self.combo_outer_copper_thickness, 0, wx.ALL|wx.EXPAND, 5 )

		self.m_staticText4011 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"Inner Copper Weight"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText4011.Wrap( -1 )

		fgSizer25.Add( self.m_staticText4011, 0, wx.ALL, 5 )

		combo_inner_copper_thicknessChoices = []
		self.combo_inner_copper_thickness = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_inner_copper_thicknessChoices, 0 )
		self.combo_inner_copper_thickness.SetSelection( 0 )
		fgSizer25.Add( self.combo_inner_copper_thickness, 0, wx.ALL|wx.EXPAND, 5 )

		self.m_staticText40111 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"Min Trace/Space Outer"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText40111.Wrap( -1 )

		fgSizer25.Add( self.m_staticText40111, 0, wx.ALL, 5 )

		combo_min_trace_width_clearanceChoices = []
		self.combo_min_trace_width_clearance = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_min_trace_width_clearanceChoices, 0 )
		...
		self.m_staticText401111 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"Min Drilled Hole"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText401111.Wrap( -1 )

		fgSizer25.Add( self.m_staticText401111, 0, wx.ALL, 5 )

		combo_min_hole_sizeChoices = []
		self.combo_min_hole_size = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_min_hole_sizeChoices, 0 )
		self.combo_min_hole_size.SetSelection( 0 )
		fgSizer25.Add( self.combo_min_hole_size, 0, wx.ALL|wx.EXPAND, 5 )

		self.m_staticText4011111 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"Solder Mask Color"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText4011111.Wrap( -1 )

		fgSizer25.Add( self.m_staticText4011111, 0, wx.ALL, 5 )

		combo_solder_colorChoices = []
		self.combo_solder_color = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_solder_colorChoices, 0 )
		self.combo_solder_color.SetSelection( 0 )
		fgSizer25.Add( self.combo_solder_color, 0, wx.ALL|wx.EXPAND, 5 )

		self.m_staticText40111111 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"Silkscreen"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText40111111.Wrap( -1 )

		fgSizer25.Add( self.m_staticText40111111, 0, wx.ALL, 5 )

		combo_silk_screen_colorChoices = []
		self.combo_silk_screen_color = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_silk_screen_colorChoices, 0 )
		...
		self.m_staticText4011111111 = wx.StaticText( labelProcessInfo.GetStaticBox(), wx.ID_ANY, _(u"Surface Finish"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText4011111111.Wrap( -1 )

		fgSizer25.Add( self.m_staticText4011111111, 0, wx.ALL, 5 )

		combo_surface_processChoices = []
		self.combo_surface_process = wx.Choice( labelProcessInfo.GetStaticBox(), wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, combo_surface_processChoices, 0 )
