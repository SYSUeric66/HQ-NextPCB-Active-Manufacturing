...
class OrderInfoView(UiOrderInfo):
    def __init__(self, *args, **kw):
        ...
        self.list_order_summary.AppendTextColumn("ITEM",  1, width=-1, mode=dv.DATAVIEW_CELL_ACTIVATABLE , align = wx.ALIGN_LEFT)
        self.list_order_summary.AppendTextColumn("QUANTITY",   2, width=-1, mode=dv.DATAVIEW_CELL_ACTIVATABLE, align = wx.ALIGN_CENTER)
        self.list_order_summary.AppendTextColumn("UNIT",   3, width=-1, mode=dv.DATAVIEW_CELL_ACTIVATABLE, align = wx.ALIGN_LEFT)
        ...
        self.list_price_detail.AppendTextColumn("Item",  1, width=-1, mode=dv.DATAVIEW_CELL_ACTIVATABLE , align = wx.ALIGN_LEFT)
        self.list_price_detail.AppendTextColumn("Price",   2, width=-1, mode=dv.DATAVIEW_CELL_ACTIVATABLE, align = wx.ALIGN_CENTER)
        price = []
        for i in range(1, 10):
