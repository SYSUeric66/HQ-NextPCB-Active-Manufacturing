...
class AmfDialogBase (wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        m_fabBaseInfo = wx.StaticBoxSizer(wx.StaticBox(
        ...
        self.m_baseMaterialLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"Material Type:"), wx.DefaultPosition, wx.Size(-1, -1), 0)
        ...
        combo_material_typeChoices = [_(u"FR-4")]
        self.combo_material_type = wx.Choice(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.DefaultPosition, wx.Size(100, -1), combo_material_typeChoices, 0)
        self.combo_material_type.SetSelection(0)
        m_fabBaseInfoSizer.Add(self.combo_material_type, wx.GBPosition(
            0, 1), wx.GBSpan(1, 2), wx.ALL | wx.EXPAND, 5)

        self.m_layerCountLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"Layer Count:"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        combo_layer_countChoices = [_(u"1"), _(u"2"), _(u"4"), _(u"6"), _(
            u"8"), _(u"10"), _(u"12"), _(u"14"), _(u"16"), _(u"18"), _(u"20")]
        self.combo_layer_count = wx.Choice(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.DefaultPosition, wx.Size(100, -1), combo_layer_countChoices, 0)
        self.combo_layer_count.SetSelection(1)
        m_fabBaseInfoSizer.Add(self.combo_layer_count, wx.GBPosition(
            1, 1), wx.GBSpan(1, 2), wx.ALL | wx.EXPAND, 5)

        self.m_pcbPackaingLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"Board Type:"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        ), wx.ID_ANY, _(u"Panel Type:"), wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_panelizeRuleLbel.Wrap(-1)

        m_fabBaseInfoSizer.Add(self.m_panelizeRuleLbel,
                               wx.GBPosition(3, 0), wx.GBSpan(1, 1), wx.ALL, 5)

        self.m_panelizeXLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"X:"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.edit_panel_x = wx.TextCtrl(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(100, -1), wx.TE_READONLY)
        self.edit_panel_x.SetMaxLength(0)
        m_fabBaseInfoSizer.Add(self.edit_panel_x, wx.GBPosition(
            4, 1), wx.GBSpan(1, 1), wx.ALL | wx.EXPAND, 5)

        self.m_panelizeXUnit = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"pcs"), wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_panelizeXUnit.Wrap(-1)

        m_fabBaseInfoSizer.Add(self.m_panelizeXUnit, wx.GBPosition(
            4, 2), wx.GBSpan(1, 1), wx.ALL, 5)

        self.edit_panel_y = wx.TextCtrl(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(100, -1), wx.TE_READONLY)
        self.edit_panel_y.SetMaxLength(0)
        m_fabBaseInfoSizer.Add(self.edit_panel_y, wx.GBPosition(
            5, 1), wx.GBSpan(1, 1), wx.ALL | wx.EXPAND, 5)

        self.m_panelizeYLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"Y:"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_panelizeYUnit = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"pcs"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_sizeLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(), wx.ID_ANY, _(
        ...
        self.m_sizeXLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"X:"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.edit_size_x = wx.TextCtrl(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(100, -1), wx.TE_READONLY)
        self.edit_size_x.SetMaxLength(0)
        m_fabBaseInfoSizer.Add(self.edit_size_x, wx.GBPosition(
            7, 1), wx.GBSpan(1, 1), wx.ALL | wx.EXPAND, 5)

        self.m_sizeXUnit = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ...
        self.m_sizeYLabel1 = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"Y:"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.edit_size_y = wx.TextCtrl(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(100, -1), wx.TE_READONLY)
        self.edit_size_y.SetMaxLength(0)
        m_fabBaseInfoSizer.Add(self.edit_size_y, wx.GBPosition(
            8, 1), wx.GBSpan(1, 1), wx.ALL | wx.EXPAND, 5)

        self.m_sizeYUnit = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"mm"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_quantityLbel = wx.StaticText(m_fabBaseInfo.GetStaticBox(), wx.ID_ANY, _(
        ...
        self.m_quantityCtrl = wx.Choice(m_fabBaseInfo.GetStaticBox(
        ...
        self.m_quantityUnit = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"Pcs"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_marginLabel = wx.StaticText(m_fabBaseInfo.GetStaticBox(), wx.ID_ANY, _(
        ...
        self.comb_margin_mode = wx.Choice(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.DefaultPosition, wx.Size(100, -1), comb_margin_modeChoices, 0)
        self.comb_margin_mode.SetSelection(0)
        m_fabBaseInfoSizer.Add(self.comb_margin_mode, wx.GBPosition(
            10, 1), wx.GBSpan(1, 1), wx.ALL | wx.EXPAND, 5)

        self.edit_margin_size = wx.TextCtrl(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(100, -1), wx.TE_READONLY)
        self.edit_margin_size.SetMaxLength(0)
        m_fabBaseInfoSizer.Add(self.edit_margin_size, wx.GBPosition(
            11, 1), wx.GBSpan(1, 1), wx.ALL | wx.EXPAND, 5)

        self.m_marginValueUnit = wx.StaticText(m_fabBaseInfo.GetStaticBox(
        ), wx.ID_ANY, _(u"mm"), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        m_fabProcessInfo = wx.StaticBoxSizer(wx.StaticBox(
        ...
        self.m_boardThicknessLabel = wx.StaticText(m_fabProcessInfo.GetStaticBox(
        ...
        self.m_outerCopperThicknessLabel = wx.StaticText(m_fabProcessInfo.GetStaticBox(
        ...
        m_fabSpecialProcess = wx.StaticBoxSizer(wx.StaticBox(
        ...
        self.m_impedanceLabel = wx.StaticText(m_fabSpecialProcess.GetStaticBox(
        ...
        self.m_testMethodLabel = wx.StaticText(m_fabServiceInfo.GetStaticBox(
        ...
        self.m_huaqiuLogo = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap(self.GetImagePath(
