...
class AmfDialogBase ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.m_panel = wx.Panel( self.m_notebook )
        self.m_panelFab = wx.ScrolledWindow( self.m_panel, wx.ID_ANY, wx.DefaultPosition, wx.Size( 300,-1 ), wx.HSCROLL|wx.VSCROLL )
        ...
        m_panel_sizer = wx.BoxSizer( wx.VERTICAL )
        m_panel_sizer.Add( self.m_panelFab, 1, wx.EXPAND )
        self.m_panel.SetSizer( m_panel_sizer )
        self.m_notebook.AddPage( self.m_panel, _(u"PCB Fabrication"), False )
